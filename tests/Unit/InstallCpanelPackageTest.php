...
namespace Laravel\Cpanel\Tests\Unit;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\File;
use Laravel\Cpanel\Tests\TestCase;
...
class InstallCpanelPackageTest extends TestCase
{
    ...
    public function the_install_command_copies_the_configuration()
    {
        ...
        if (File::exists(config_path('cpanel.php'))) {
            unlink(config_path('cpanel.php'));
        }

        $this->assertFalse(File::exists(config_path('cpanel.php')));

        Artisan::call('cpanelpackage:install');

        $this->assertTrue(File::exists(config_path('cpanel.php')));
    }
    ...
    public function when_a_config_file_is_present_users_can_choose_to_not_overwrite_it()
    {
        ...
        File::put(config_path('cpanel.php'), 'test contents');
        $this->assertTrue(File::exists(config_path('cpanel.php')));

        // When we run the install command
        $command = $this->artisan('cpanelpackage:install');
        ...
        $this->assertEquals('test contents', file_get_contents(config_path('cpanel.php')));
    ...
    public function when_a_config_file_is_present_users_can_choose_to_do_overwrite_it()
    {
        ...
        $this->assertEquals(
            ...
            file_get_contents(config_path('cpanel.php'))
        );
